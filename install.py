...
#Start now
os.system("cls || clear") 
print(CY+ "This script will help you in installing required packages for Bas64 bash script") 
time.sleep(3)
os.system("pkg install git") 
os.system("pip install lolcat") 
os.system("pip install figlet") 
os.system("pkg install wget && pkg install curl && pkg install clang && pkg install unzip") 
os.system("cd $HOME") 
os.system("cd Bas64") 
...
#I am AnonyminHack5, a white hat hacker
